			...
			<div class="well well-small">
				<ul class="nav nav-list">
					...
					<li><a href="<c:url value="/san-pham/${item.id }"/>"><span
							class="icon-circle-blank"></span>${item.nameString}</a></li>
					</c:forEach>
				...
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<c:forEach var="item" items="${slides}" varStatus="index">
							...
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/${item.imgString }"/>"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
								<h4>${item.captionString }</h4>
								<p>
									<span>${item.contentString }</span>
								</p>
							</div>
							</div>
						</c:forEach>
...
-->
	...
	-->
		<div class="well well-small">
			<h3>
				<a class="btn btn-mini pull-right" href="<c:url value="/xem-them/hightlightProducts"/>"
			...
			<div class="row-fluid">
				<c:if test="${hightlight_products.size()>0 }">
					<ul class="thumbnails">
					<c:forEach var="item" items="${hightlight_products }" varStatus="loop">
						<li class="span4">
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								title="add to cart"><span class="icon-search"></span> QUICK
							...
							<div class="caption">
								...
								<h4>
									<a class="defaultBtn" href="product_details.html"
										...
										class="shopBtn" href="<c:url value="/AddCart/${item.id_product }"></c:url>" title="add to cart"><span
					...
					<c:if test="${(loop.index+1)%3==0 ||(loop.index+1)==hightlight_products.size() }">
						</ul>
