...
<div class="span9">
	...
	<div class="well well-small">
		<h1>Giỏ hàng <small class="pull-right">Tổng tiền <fmt:formatNumber type="number" groupingUsed="true" value="${ TotalPriceCart }"/> ₫ </small></h1>
	<hr class="soften"/>	
	...
	<a href='<c:url value="thanh-toan"></c:url>' class="shopBtn btn-large pull-right">Thanh toán <span class="icon-arrow-right"></span></a>
